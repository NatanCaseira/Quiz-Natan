...
public class Player : MonoBehaviour
{
    ...
    [Header("Power Up")]
    public Transform powerEsq;
    public Transform powerDir;
    ...
    IEnumerator AtirarCleber()
    {
        ...
        if (powerUp1Ativo)
        {
            Instantiate(tiroPowerUp,powerDir.position,Quaternion.identity);
            Instantiate(tiroPowerUp, powerEsq.position, Quaternion.identity);
        }
